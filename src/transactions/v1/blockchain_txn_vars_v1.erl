...
validate_var(?staking_fee_txn_assert_location_v2, Value) ->
    %% the staking fee price for an assert location v2 txn, in DC
    validate_int(Value, "staking_fee_txn_assert_location_v2", 0, 1000 * ?USD_TO_DC, false);
